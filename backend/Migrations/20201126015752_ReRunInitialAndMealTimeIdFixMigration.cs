...
{
    public partial class ReRunInitialAndMealTimeIdFixMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -1, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), "-1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -1, 860, 100, -1, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), 30, null, @"* Cook Chicken
                * Cook Potatoes
                * Smother in Hot Sauce", "Chicken and Potatoes with Hot Sauce", "* Marinate Chicken for at least 12 hours for maximum flavor", 35m, 70, 2, "[\"Spicy\"]" },
                    { -3, 222, 10, -1, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), 11, null, @"* 1. Place the olive oil, garlic, chilies, onion, and ginger in a blender and purée until smooth.
                ...
                * 6. Add the cream and butter and stir to combine. Season with salt and serve garnished with fresh cilantro with steamed Jasmine rice.", "Butter Chicken", "* Delicious!", 65m, 20, 8, "[\"Chicken, Dinner, Easy\"]" },
                    { -5, 148, 6, -1, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), 3, null, @"* 1. Preheat grill or broiler.
                ...
                * When grilling delicate foods like tofu and fish, it is helpful to spray the food with cooking spray.", 45m, 23, 4, "[\"Low calorie, Low fat, Low Sodium\"]" },
                    { -2, 770, 115, -2, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), 10, null, @"* Cook Steak on BBQ
                ...
                * Potatoes can be diced, sliced, or baked. Personal preference.", 25m, 70, 2, "[\"BBQ\"]" },
                    { -4, 375, 45, -4, new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 11, 25, 0, 0, 0, 0, DateTimeKind.Local), 16, null, @"* 1. Combine beans, cheese and 1/4 cup salsa in a medium bowl.
