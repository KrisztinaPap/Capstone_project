    ...
    public partial class InitMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                * 8. Serve the quesadillas with avocado and the remaining salsa.", "Black Bean Quesadillas", "Tip: Look for prepared fresh salsa in the supermarket refrigerator section near other dips and spreads.", 25m, 13, 4, "[\"Low calorie, High fiber, Vegetarian\"]", null }
                });
