...
{
    public partial class EditRecipeInstructionsSeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), @"1. Preheat grill or broiler.
...
* When grilling delicate foods like tofu and fish, it is helpful to spray the food with cooking spray." });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), @"1. Combine beans, cheese and 1/4 cup salsa in a medium bowl.
...
8. Serve the quesadillas with avocado and the remaining salsa." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -3,
                columns: new[] { "DateCreated", "DateModified", "Instructions" },
                values: new object[] { new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), @"* 1. Place the olive oil, garlic, chilies, onion, and ginger in a blender and purée until smooth.
...
* 6. Add the cream and butter and stir to combine. Season with salt and serve garnished with fresh cilantro with steamed Jasmine rice." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -2,
                columns: new[] { "DateCreated", "DateModified", "Instructions", "Notes" },
                values: new object[] { new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), @"* Cook Steak on BBQ
...
* Potatoes can be diced, sliced, or baked. Personal preference." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -1,
                columns: new[] { "DateCreated", "DateModified", "Instructions" },
                values: new object[] { new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2020, 12, 7, 0, 0, 0, 0, DateTimeKind.Local), @"* Cook Chicken
* Cook Potatoes
